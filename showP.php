...
$link=$row['propertyID'];
	?>
			<li><?php echo $row['address'] .",".$row['city'].",".$row['zipcode'];?><a href="deleteP.php<?php echo "?link=".$link ;?>">Delete Property</a> ....... <a href="updateP.php<?php echo "?link=".$link ;?>">Update Property</a></li>
